package vn.com.flight.exceptions;
...
public enum DExCode implements InfoCode {
   ...
   * 0: date of birth
   */
  INVALID_DOB("Date of birth {0} is not a valid date"), INVALID_INTERNAL_MARK(""), INVALID_EXAM_MARK(""), INVALID_CREATEDATE(""), INVALID_DEPARTUREDATE("Departure Date {0} is not a valid date"), INVALID_ARRIVALDATE("Arrival {0} is not a valid date"), INVALID_DATE("INVALID DATE"), INVALI_EMAIL("INVALID EMAIL!"), INVALID_CARRENTALPRICE("Arrival{0} is not a suitable price"), INVALID_HOTELPRICE("Arrival{0} is not a suitable price")
  ;
