...
public class CustomersByCityJoinReport {
  ...
  @DAttr(name="customer",type=Type.Collection,optional=false, mutable=false,
     ...
     Customer.A_email, Customer.A_rptCustomerByCity})
      ,derivedFrom={"cityName"})
  @DAssoc(ascName="customer-by-cityName-report-has-customer",role="report",
  ...
  public CustomersByCityJoinReport(@AttrRef("cityName") String name) throws NotPossibleException, DataSourceException 
  {
    this.id=++idCounter;
...
//    boolean doReportQuery = (cityName != null && !cityName.equals(this.name));
  ...
  public void doReportQuery() throws NotPossibleException, DataSourceException 
  {
    ...
    Query q = QueryToolKit.createSimpleJoinQuery(dsm, Customer.class, City.class,  
        Customer.A_address, 
        City.A_name, 
        Op.MATCH, 
        "%"+cityName+"%");
   ...
   * However, this method is empty because customer have already be recorded in the attribute {@link #customer}.
   */
  @DOpt(type=DOpt.Type.LinkAdder)
  public boolean addCustomer(Collection<Customer> customer) 
  {
    // do nothing
  ...
  public boolean equals(Object obj) 
  {
    ...
    if (getClass() != obj.getClass())
      return false;
    CustomersByCityJoinReport other = (CustomersByCityJoinReport) obj;
    if (id != other.id)
      return false;
    return true;
  }
